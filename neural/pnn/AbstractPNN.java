...
public abstract class AbstractPNN  extends BasicML {
	...
	private static final long serialVersionUID =24134652362L;
	/**
	 * Input neuron count.
	 */
	...
	public AbstractPNN(final PNNKernelType kernel, final PNNOutputMode outputMode,
			final int inputCount, final int outputCount,final boolean usePriors) {
		this.kernel = kernel;
	...
	public boolean usePriors(){
		return usePriors;
	}
	
	public abstract ConfusionMatrix computeConfusionMatrix(MLDataSet dataSet);
	...
	public abstract List<MLData> compute(MLDataSet dataset);
